...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="card mt-2">
                    <div class="card-header bg-dark text-light fw-bold">Tambah Foto</div>
                    <div class="card-body">
                        <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary mt-2" name="tambah"><i class="bi bi-file-earmark-plus"></i> Tambah Data</button>
                        </form>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="card mt-2">
                    <div class="card-header bg-dark text-light fw-bold">Data Galeri Foto</div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                            data-bs-target="#edit<?php echo $data['fotoid'] ?>"><i class="bi bi-pencil-square"></i>                                        </button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i> Edit</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#hapus<?php echo $data['fotoid'] ?>"><i class="bi bi-trash"></i>
                                        </button>
                                        ...
                                        <div class="modal fade" id="hapus<?php echo $data['fotoid'] ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="hapus" class="btn btn-danger"><i class="bi bi-trash"></i> Hapus</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
