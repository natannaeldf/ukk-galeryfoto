    ...
    <nav class="navbar navbar-expand-lg bg-dark mb-2">
        <div class="container">
            ...
            <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
                ...
                <a href="register.php" class="btn btn-outline-primary m-1"><i class="bi bi-file-text"></i> Daftar</a>
                <a href="login.php" class="btn btn-outline-primary m-1"><i class="bi bi-box-arrow-in-right"></i> Masuk</a>
            </div>
        </div>
    </nav>
